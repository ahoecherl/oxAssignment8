...
print(timeit.timeit(lambda: price_only(), number=2500))
print('Time for 5000 pricings with analytical delta, vega, theta, rho')
print(timeit.timeit(lambda: analytical_derivatives(), number=2500))
print('Time for 5000 pricings and derivatives with forward Bump')
print(timeit.timeit(lambda: forward_bump_derivatives(), number=2500))
print('Time for 5000 pricings and derivatives with SAD')
print(timeit.timeit(lambda: SAD_derivatives(), number=2500))
print('Time for 5000 pricings and derivatives with AAD')
print(timeit.timeit(lambda: AAD_derivatives(), number=2500))
print('Time for 5000 pricings and derivatives with AAAD')
print(timeit.timeit(lambda: AAAD_derivatives(), number=2500))
asdf=1
